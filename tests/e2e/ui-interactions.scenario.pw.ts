  ...
  await when(
    {
      ...
      covers: [
        'TextField.onChange@application-workspace-container.values.setJobTitle',
        'TextField.onChange@application-workspace-container.values.setCompany',
        'TextField.onChange@application-workspace-container.values.setStrengths',
        'TextAreaField.onChange@application-workspace-container.values.setDetails',
  ...
  await when(
    {
      ...
      covers: [
        'src/components/ui/button/Button.tsx#Button.onClick:click@src/routes/applications.index.tsx#createApplication@119:4@src/routes/applications.index.tsx:60:4',
        'src/components/ui/button/Button.tsx#Button.onClick:click@src/routes/applications.index.tsx#createApplication@119:4@src/routes/applications.index.tsx:65:6',
      ],
    },
    async () => {
  ...
  await when(
    {
      description: 'open and close the subscription modal',
      covers: [
        'src/components/ui/button/Button.tsx#Button.onClick:click@src/routes/applications.index.tsx#setSubscriptionModalVisible@119:4@src/routes/applications.index.tsx:52:4',
        'src/components/ui/button/Button.tsx#Button.onClick:click@src/routes/applications.index.tsx#setSubscriptionModalVisible@119:4@src/routes/applications.index.tsx:65:6',
      ],
    },
